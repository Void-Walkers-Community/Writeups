# 🔍 Digital Forensics: Evidence Recovery & Artifact Analysis

Welcome to the Void-Walkers Forensic Lab. This directory documents our deep-tissue analysis of digital media. From volatile memory (RAM) to persistent storage and network captures, we reconstruct the timeline of an incident to find the truth.
...
> "Data never lies, but it can be hidden. We just look closer." 🌌
