# 🌀 Miscellaneous: Logic, Jails & Esoteric Challenges

Welcome to the Void-Walkers Singularity. This directory is for the "unclassifiable"—the puzzles that test raw logic, scripting speed, and the ability to escape restricted environments. If it's weird, it lives here.
...
> "If it doesn't have a category, it belongs to the Void." 🌌
