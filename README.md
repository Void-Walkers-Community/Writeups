...
1. **Naming Convention:** Create a sub-folder inside the category using the format `[Year]-[Event]-[ChallengeName]`.
2. **The Writeup:** Inside your folder, include a `README.md` containing:
   * **Challenge Info:** Points, difficulty, and original description.
