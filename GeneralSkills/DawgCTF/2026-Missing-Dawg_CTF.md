...
Alice is completely absent here, and Bob begins by waiting for a message. Since no legitimate sender appears, we can directly send Bob the exact plaintext request he expects.
