# ☁️ Cloud Security: Infrastructure & IAM Exploitation

Welcome to the Void-Walkers Cloud Command. This directory tracks our breaches of virtualized environments, serverless architectures, and misconfigured cloud identity providers. In the cloud, the perimeter is defined by policies, not just firewalls.
...
> "There is no cloud, just someone else's misconfigured computer." 🌌
